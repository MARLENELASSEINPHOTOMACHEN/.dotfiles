...
do
  ...
  local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'css', 'javascript', 'typescript', 'regex', 'zig' } --MARLENE appended css/js/ts/regex/zig
