...
vim.g.have_nerd_font = true --MARLENE
...
vim.o.relativenumber = true --MARLENE
...
require("lazy").setup({
	...
	{ -- Adds git related signs to the gutter, as well as utilities for managing changes
		...
		opts = {
			...
			on_attach = function(bufnr) --MARLENE start gitsigns keymaps
				...
				-- Actions
				-- visual mode
				-- map("v", "<leader>hs", function() --MARLENE commented out <leader>h keymaps
	...
	{ -- Autoformat
		...
		keys = {
			...
			{ --MARLENE added write without formatting
				"<leader>cw",
				"<cmd>noautocmd w<cr>",
				mode = "",
	...
	{ -- You can easily change to a different colorscheme.
		...
		-- "folke/tokyonight.nvim", --MARLENE commented, using seoul256
		"junegunn/seoul256.vim", --MARLENE
		priority = 1000, -- Make sure to load this before all the other start plugins.

		config = function() --MARLENE
