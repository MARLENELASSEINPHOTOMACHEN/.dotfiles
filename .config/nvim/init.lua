...
do
	...
	gitsigns.setup({
		...
		on_attach = function(bufnr)
			...
			--MARLENE start commented, `<leader>h` prefix collides with harpoon (Section 10)
			-- Visual mode actions
...
do
	...
	end, { desc = "[F]ormat buffer" }) --MARLENE
...
do
	...
	local parsers = {
		...
		"regex",
		"zig",
	} --MARLENE appended css/js/ts/regex/zig
